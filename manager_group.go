...
func (m *Manager) getDatacenterByName(token string, name string) (d Datacenter, err error) {
...
func (m *Manager) getGroupByName(token string, name string) (g Group, err error) {
